...
import (
	...
	"github.com/Hari-Krishna-Moorthy/ride-booking-saga/services/booking-service/internal/httpapi"
	"github.com/Hari-Krishna-Moorthy/ride-booking-saga/services/booking-service/internal/messaging"
	"github.com/Hari-Krishna-Moorthy/ride-booking-saga/services/booking-service/internal/repository"
	"github.com/Hari-Krishna-Moorthy/ride-booking-saga/services/booking-service/migrations"
...
func main() {
	...
	idemPrefix := envOr("IDEMPOTENCY_PREFIX", "booking-service")
	...
	handler := httpapi.NewHandler(svc, repo)
